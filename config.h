...
static const char *helpcmd[]  		= { "dmenu_doc", "bin/doc/docfiles/mon", NULL };
static const char *scriptscmd[] 	= { "dmenu_doc", "bin/scripts", NULL };
static const char *pythoncmd[] 	    = { "dmenu_doc", "bin/doc/docfiles/python", NULL };
static const char *ccmd[] 	        = { "dmenu_doc", "bin/doc/docfiles/c", NULL };
